...
let store = {
    ...
    getAvatarImage(index) {
        return this._avatarImage.imgs[index].src;
    },
    _state: {
        profilePage: {
            posts: [
        ...
        dialogsPage: {
            dialogs: [
                { id: 1, name: 'Дмитрий', imgSrc: this.getAvatarImage(0) },
                { id: 2, name: 'Светлана', imgSrc: this.getAvatarImage(1) },
                { id: 3, name: 'Женя', imgSrc: this.getAvatarImage(3) },
                { id: 4, name: 'Андрей', imgSrc: this.getAvatarImage(4) },
                { id: 5, name: 'Александр', imgSrc: this.getAvatarImage(2) },
                { id: 6, name: 'Мария', imgSrc: this.getAvatarImage(1) },
            ],
            messages: [
                { id: 1, message: 'Привет!' },
        ...
        friendsPage: {
            friends: [
                { id: 1, imgSrc: this.getAvatarImage(0), name: 'Михаил', surname: 'Павлов' },
                { id: 2, imgSrc: this.getAvatarImage(3), name: 'Дмитрий', surname: 'Иванов' },
                { id: 3, imgSrc: this.getAvatarImage(1), name: 'Светлана', surname: 'Ясная' },
                { id: 4, imgSrc: this.getAvatarImage(1), name: 'Елена', surname: 'Гребникова' },
                { id: 5, imgSrc: this.getAvatarImage(2), name: 'Женя', surname: 'Казанский' },
                { id: 6, imgSrc: this.getAvatarImage(4), name: 'Кирилл', surname: 'Эльман' },
            ]
        },
    },
    getState() {
